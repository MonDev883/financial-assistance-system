...
function ClaimantLogin(){
  ...
  async function handleSubmit(e){
    ...
    try {
      const res = await API.post("/claimants/login", form)
      localStorage.setItem("claimantToken", res.data.token)
      localStorage.setItem("claimant", JSON.stringify(res.data.claimant))
      ...
      <div className="bg-white rounded-2xl shadow-2xl p-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm">
            City Hall — Sign in to your account
          </p>
        </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          ...
          <Link to="/claimant/register" className="text-green-600 font-semibold hover:underline">
            Register here
          </Link>
        </p>
        ...
        <div className="mt-6 pt-6 border-t border-gray-100 text-center">
          <p className="text-xs text-gray-400 mb-3">Are you a City Hall staff?</p>
          <Link
            to="/staff/login"
